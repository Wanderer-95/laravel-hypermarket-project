...
async function updateProduct() {
    ...
    const res = await httpRequest(route('admin.products.update', props.product.id), 'POST', formData);
...
<template>
    <AdminLayout>
        <div class="mx-auto max-w-md space-y-4 rounded-lg bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-2xl font-semibold text-gray-700">Обновить группу продуктов</h2>
            <div>
