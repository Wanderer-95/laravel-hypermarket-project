...
<template>
    ...
    <AdminLayout>
        <table class="mb-4 min-w-full divide-y divide-gray-200 border border-gray-300">
            ...
            <tr class="hover:bg-gray-50" :key="product.id" v-for="product in productsData">
                ...
                <td class="px-4 py-2 text-sm text-gray-900 flex items-center gap-3">
                    ...
                    <button @click.prevent="deleteProduct(product)" class="text-red-600 hover:text-red-800 cursor-pointer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
